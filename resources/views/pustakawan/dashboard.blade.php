...
@section('title', 'Librarian Dashboard - Perpustakaan Digital')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 gradient-card rounded-2xl overflow-hidden">
            ...
            <div class="px-6 py-4 border-t-2 border-koshouko-border">
                <a href="{{ route('librarian.borrowings') }}" class="text-koshouko-wood hover:text-koshouko-red font-semibold text-sm">
                    Lihat Semua →
                </a>
            </div>
        </div>
        ...
        <div class="space-y-6">
            <div class="gradient-card rounded-2xl p-6">
                ...
                <div class="space-y-3">
                    <a href="{{ route('librarian.books.create') }}" class="block px-4 py-3 bg-koshouko-wood/10 text-koshouko-wood rounded-lg font-semibold hover:bg-koshouko-wood/20 transition text-center border border-koshouko-border">
                        ➕ Tambah Buku
                    </a>
                    <a href="{{ route('librarian.borrowings') }}" class="block px-4 py-3 btn-koshouko rounded-lg font-semibold transition text-center">
                        ✓ Kelola Peminjaman
                    </a>
                    <a href="{{ route('librarian.announcements') }}" class="block px-4 py-3 bg-koshouko-red/10 text-koshouko-red rounded-lg font-semibold hover:bg-koshouko-red/20 transition text-center border border-koshouko-border">
                        📢 Posting Pengumuman
                    </a>
                </div>
            </div>
