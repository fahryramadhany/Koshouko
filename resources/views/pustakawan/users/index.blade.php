...
@section('title', 'Kelola User - Pustakawan')
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-koshouko-border">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center py-8 text-koshouko-text-muted">Belum ada user.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (reportForm) {
            reportForm.addEventListener('submit', function(e) {
                ...
                generatePDFReport('{{ route('librarian.users.report') }}', reportType, 'Laporan-User');
            });
        }
    });
    </script>
