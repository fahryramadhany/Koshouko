        ...
        <div class="lg:col-span-1">
            <div class="sticky top-24 space-y-4">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <a href="{{ route('librarian.books.edit', $book) }}" class="w-full px-6 py-3 btn-koshouko rounded-lg font-semibold transition text-center">Edit Buku</a>
                    <form action="{{ route('librarian.books.destroy', $book) }}" method="POST" class="w-full" onsubmit="return confirm('Yakin ingin menghapus buku ini?');">
                        @csrf @method('DELETE')
