...
<link rel="stylesheet" href="{{ asset('css/admin-pages.css') }}">
    ...
    <div class="max-w-2xl">
        <div class="gradient-card rounded-2xl p-8">
            <form action="{{ route('admin.books.categories.update', $category) }}" method="POST" class="space-y-6">
                @csrf @method('PUT')
                ...
                <div class="flex gap-4">
                    ...
                    <a href="{{ route('admin.books.categories') }}" class="flex-1 px-6 py-3 border-2 border-koshouko-border text-koshouko-wood rounded-lg font-semibold hover:bg-koshouko-cream transition text-center">
                        Batal
                    </a>
                </div>
            </form>
