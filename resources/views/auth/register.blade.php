        ...
        <div class="flex-1 flex items-center justify-center px-4 py-12">
            <div class="w-full max-w-md">
                <div class="card-light rounded-2xl p-8 glow fade-in">
                    <!-- Header -->
                    <div class="mb-8">
                        <h2 class="text-2xl font-bold mb-2 text-koshouko-text">Buat Akun Baru</h2>
                        <p class="text-koshouko-text-muted text-sm">Daftar untuk mengakses perpustakaan kami</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-4">
                        ...
                        <!-- Name -->
                        <div>
                            <label class="block text-sm font-medium mb-2 text-koshouko-text">Nama Lengkap</label>
                            <input type="text" name="name" value="{{ old('name') }}" required
                                class="input-light w-full" placeholder="Masukkan nama Anda">
                            @error('name')
                        ...
                        <!-- Phone -->
                        <div>
                            <label class="block text-sm font-medium mb-2 text-koshouko-text">Nomor Telepon</label>
                            <input type="tel" name="phone" value="{{ old('phone') }}" required
                                class="input-light w-full" placeholder="Masukkan nomor telepon">
                            @error('phone')
                                <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Date of Birth -->
                        <div>
                            <label class="block text-sm font-medium mb-2 text-koshouko-text">Tanggal Lahir</label>
                            <input type="date" name="date_of_birth" value="{{ old('date_of_birth') }}" required
                                class="input-light w-full" style="color-scheme: light;">
                            @error('date_of_birth')
                                <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Confirm Password -->
                        <div>
                            <label class="block text-sm font-medium mb-2 text-koshouko-text">Konfirmasi Password</label>
                            <input type="password" name="password_confirmation" required
                                class="input-light w-full" placeholder="Konfirmasi password">
                        </div>
                    ...
                    <p class="text-center text-sm text-koshouko-text-muted">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" class="gradient-text font-semibold hover:underline">
                            Masuk di sini
                        </a>
                    </p>
                </div>
