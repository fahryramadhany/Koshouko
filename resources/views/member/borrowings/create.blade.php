...
@section('title', 'Formulir Peminjaman - Perpustakaan Digital')
@section('page-title', '📋 Formulir Peminjaman Buku')
...
<script>
    ...
    // Initialize with today's date and restore any preselected values (used by /books/{id}/borrow)
    window.addEventListener('DOMContentLoaded', function() {
        ...
        // restore preselected book (from controller or old input)
